...
router.post('/post', verificaJWT,async (req, res) => {
    ...
    router.get('/getAll', verificaJWT,async (req, res) => {
        ...
        //Update
            ...
            // Encontra pela descrição
            router.get("/encontraPorParteDaDescricao/:parteDaDescricao", verificaJWT,async (req, res) => {
                    try 
                    {
                        const resultados = await modeloTarefa.find({
                    ...
                    router.get("/getAllDone", verificaJWT ,async (req, res) => {
                        try {
